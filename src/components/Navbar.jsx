    ...
    return (
        <>
            <nav class="bg-white-100 border-gray-200 dark:bg-gray-900 drop-shadow-2xl">
                <div class="max-w-screen-xl flex flex-wrap items-baseline justify-between mx-0">
                    ...
                    <div class="hidden w-full md:block md:w-max" id="navbar-default">
                        <ul class="font-medium flex flex-col items-center p-4 mr-10 md: bg-transparent mb-5 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md: dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <Link to="/" class="block py-2 px-3 text-white rounded md:bg-blue-700 md:text-white md:pt-1 pb-1 pl-2 pr-2 dark:text-white md:dark:text-white hover:text-white" aria-current="page">Accueil</Link>
                            </li>
                            <li>
