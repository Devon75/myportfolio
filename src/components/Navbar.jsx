...
function Navbar() {
    ...
    return (
        <>
            <nav class="min-h-20 flex items-center justify-center bg-gradient-to-tr from-emerald-50 to-lime-50 border-solid border-b-2 border-emerald-950 drop-shadow-2xl dark:bg-gray-900">
                ...
                <div class="w-4/5 items-center justify-center minus:hidden sm:hidden md:block md:w-max" id="navbar-default">
                    <ul class="flex items-center mx-60 justify-around md: bg-transparent  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md: dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/" class="block rounded text-center bg-emerald-950 text-white pt-2 pb-2 pl-1 pr-1 hover:text-white md:text-white md:p-1 dark:text-white md:dark:text-white hover:text-white-100" aria-current="page">Accueil</Link>
                        </li>
                        <li>
                            <Link to="/moi" class="block text-center text-emerald-950 rounded hover:bg-blanclune-100 hover:text-emerald-400 md:border-0 md:hover:text-gray-700 md:pt-1 pb-1 pl-2 pr-2 dark:text-white md:dark:hover:text-teal-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">A propos de moi</Link>
                        </li>
                        <li>
                            <Link to="/Cv" class="block text-center text-emerald-950 rounded hover:bg-blanclune-100 hover:text-emerald-400 md:border-0 md:hover:text-gray-700 md:pt-1 pb-1 pl-2 pr-2 dark:text-white md:dark:hover:text-teal-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">CV</Link>
                        </li>
                        <li>
                            <Link to="/Projet" class="block text-center text-emerald-950 border-2 border-transparent border-r-emerald-950 pr-5 hover:bg-blanclune-100 hover:text-emerald-400 md:border-0 md:hover:text-gray-700 md:pt-1 pb-1 pl-2 pr-2 dark:text-white md:dark:hover:text-teal-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Projet</Link>
                        </li>
                        <li>
