    ...
    return (
        <>
            <nav class="min-h-20 flex items-center justify-center bg-gradient-to-tr from-emerald-50 to-lime-50 border-solid border-b-2 border-emerald-950 drop-shadow-2xl">
                <div class="w-2/5 items-start justify-center border-2 border-yellow-600 minus:flex minus:w-full minus:px-5 minus:items-center minus:justify-between sm:flex sm:w-full sm:px-5 sm:items-center sm:justify-between">
                    <Link to="/" class="flex items-baseline justify-center space-x-3 border-2 border-cyan-600 rtl:space-x-reverse minus:mb-0 minus:h-full sm:ml-16">
                ...
                <div class="w-3/5 items-center justify-center border-2 border-orange-500 minus:hidden sm:hidden md:block md:w-max" id="navbar-default">
