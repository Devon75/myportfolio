            ...
            <form>
                ...
                <div class="grid grid-cols-2 grid-rows-2 ml-28 mb-6 minus:ml-5 minus:mr-5 sm:ml-16">
                    <div class="col-span-2 h-5">
                        ...
                        <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">J'accepte les <a href="#" class="text-emerald-950 hover:text-emerald-400 hover:underline dark:text-blue-500">termes et conditions</a>.</label>
                    </div>
                    <button type="submit" class="col-1 w-fit mr-28 text-white bg-emerald-950 hover:bg-menthegreen-300 hover:border-transparent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-fit px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </div>
            </form>
