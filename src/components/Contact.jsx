function Contact() {
    return (
        ...
        <form>
            <div class="ml-28 mr-32 mt-5 grid gap-6 mb-6 md:grid-cols-2">
                <div>
            ...
            <div class="grid grid-cols-2 grid-rows-2 ml-28 mb-6">
                ...
                <button type="submit" class="col-1 w-1/6 mr-28 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </div>
